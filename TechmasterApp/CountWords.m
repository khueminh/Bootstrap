...
- (void)viewDidLoad {
    ...
    [self writeln:@"Ket qua dem tu:"];
    
    //Tao mang
    
    NSArray *arrayOfWordsTemp = [string componentsSeparatedByCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]; //componentsSeparatedByString:@" "
    
    [arrayOfWordsTemp WordsOccurenceCount];
